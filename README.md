...
- Diagnostics: `GET /api/rest/internal/runtime-memory` (`heapUsed` / `vmRss` / `rssAnon` / `rssFile` / `threads` in MB + idle reclaim state)
- Health: `GET|HEAD /api/rest/internal/health` → `ok`
