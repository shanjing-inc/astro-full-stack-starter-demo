...
- `/test/graphql`: sends preset or custom requests to the member and admin GraphQL endpoints backed by the D1 provider.
- `/test/database`: checks the D1 binding, Drizzle D1 provider, and `shop` table preview.
