/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts --env dev` (hash: 40ca836094a6423e4c3b3af8d8bb8f38)
...
interface __BaseEnv_Env {
    ...
    LOG_SQL: "false";
    QUEUE_EXECUTION_RECORD_TTL_SECONDS: "604800";
    SENTRY_DSN: "";
    SENTRY_RELEASE: "dev";
    WEBSOCKET_ALLOWED_ORIGINS: "http://localhost:4321,http://127.0.0.1:4321";
    WEBSOCKET_IDLE_TIMEOUT_SECONDS: "120";
    WEBSOCKET_MAX_CONNECTIONS: "100";
    BETTER_AUTH_SECRET: string;
    WEBSOCKET_ROOM: DurableObjectNamespace<import("./worker").PublicWebSocketRoom>;
    CACHE_OBJECT: DurableObjectNamespace<import("./worker").CacheObject>;
}
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./worker");
        durableNamespaces: "PublicWebSocketRoom" | "CacheObject";
    }
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<
        Pick<
            ...
            | "LOG_SQL"
            | "QUEUE_EXECUTION_RECORD_TTL_SECONDS"
            | "SENTRY_DSN"
            | "SENTRY_RELEASE"
